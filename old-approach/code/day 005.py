...
def calculate_virality_and_confidence(papers, cross_refs):
    ...
    print("\n📊 Calculating virality + confidence scores...")
    ...
    print(f"\n🎯 Papers with ≥65% confidence: {high_conf}/{len(scored)}")
...
def search_with_confidence(query, chroma_client, embed_model, min_confidence=60):
    """Search and return best paper with ≥min_confidence%"""
    
    print(f"\n🔍 Searching with ≥{min_confidence}% confidence filter...")
    ...
    print(f"⚠️ No papers ≥{min_confidence}% confidence, returning top match")
...
print("💪 Week 1 COMPLETE! You have production-grade multi-source intelligence!")

print(f"\n" + "="*60)
print("WEEK 1 ACHIEVEMENT UNLOCKED 🏆")
print("="*60)
print("\nYou built:")
...
print("✓ 100% local infrastructure")
