...
print(f"ðŸ¦™ Using: Ollama + {llmModelCode} (100% local)")
...
print(f"ðŸ“… Published: {paper['published']}")
print(f"ðŸ”— URL: {paper['url']}\n")
print(f"ðŸ“ Summary: {paper['summary'][:200]}...")
...
print(f"ðŸ“Š Current papers in DB: {collection.count()}")
...
print("\n" + "="*60)
print("ðŸŽ‰ DAY 1 COMPLETE - 100% LOCAL STACK")
print("="*60)
...
print("ðŸ’ª 100% local. 100% free. 100% yours.")
